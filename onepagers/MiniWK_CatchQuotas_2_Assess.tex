...
black sea bass and for bluefish (forage fish index influences
recreational index catchability). This integration was based on ESPs and
accepted through peer review (Catch/Quota Setting Step 3).}
...
indicators and metrics of stock status should also be included.
Indicators above plus habitat information: *
