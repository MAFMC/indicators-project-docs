...
\section{Catch/Quota Setting: Potential Indicators and
Pathways}\label{catchquota-setting-potential-indicators-and-pathways}

\begin{noteblock}
Catch and Quota Setting is a multistep process involving decisions by
the Northeast Regional Coordinating Committee (Mid Atlantic and New
England Councils, Commission, and Science Center), assessment
scientists, assessment peer reviewers, the Council's Scientific and
...
\tightlist
\item
  \textbf{Key question: What additional indicators could inform ? Could
  in addition to improve the process?}
\item
...
\tightlist
\item
  Determine Assessment Terms of Reference
\end{enumerate}
