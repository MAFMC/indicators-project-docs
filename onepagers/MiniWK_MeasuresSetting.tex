...
regulations such as gear requirements, spatial or temporal openings and
closures, and size and bag limits.
...
\item
  ...
  multifleet objectives in the measures setting process?}
\end{itemize}
...
Current measures are outlined by NOAA's
...
\item
  ...
  limits. Recreational measures are designed to achieve the target level
  of harvest, informed by the Recreational Harvest Limit (RHL) and stock
  status. Measures can also be informed by other considerations such as
  angler welfare.
\item
  Measures are set in specifications. The process for setting measures
  can be changed by either FMP amendment or framework action.
\end{itemize}
...
\item
  ...
  to measures (summer flounder, scup, and black sea bass only)
