...
GRAs have remained the same for years. They are currently being
...
\begin{center}\includegraphics[width=0.87\linewidth]{rhapcast-screencap} \end{center}
...
\tightlist
\item
  Appropriate spatial indicator information could be provided to fishery
  participants to help them decide how to avoid bycatch and achieve
  management objectives for bycatch reduction, and/or the Council could
  implement spatial measures.
\item
  Indicators of bycatch magnitude for specific areas could be monitored
...
for all sectors/fleets due to confidentiality. There are often
challenges to map fishing fleet effort to specific species, and with
mismatches in spatial and temporal scale of management areas and
processes. Spatial measures also have implications for future
monitoring.
